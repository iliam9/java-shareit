...
public class UserDtoTest {
    ...
    void serializeJsonTest() throws Exception {
        ...
        userDto.setName("Ilya");
        userDto.setEmail("ilya@yandex.ru");

        String json = objectMapper.writeValueAsString(userDto);
        assertThat(json).contains("\"name\":\"Ilya\"","\"email\":\"ilya@yandex.ru\"");
    }
    ...
    void deserializeJsonTest() throws Exception {
        ...
        final String json = "{\"id\":1,\"name\":\"Ilya\",\"email\":\"ilya@yandex.ru\"}";

        final UserDto userDto = objectMapper.readValue(json, UserDto.class);
        assertThat(userDto.getName()).isEqualTo("Ilya");
    }
